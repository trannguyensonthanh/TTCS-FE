...
import { ChevronRight, Calendar, Users, Award, GraduationCap, Bookmark, MapPin } from 'lucide-react';
...
const upcomingEvents = [
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1504384308090-c894fdcc538d?q=80&w=1170',
  },
  {
    id: '2',
...
const testimonials = [
  {
    ...
    quote: 'Các sự kiện tại PTITHCM luôn được tổ chức chuyên nghiệp, mang lại nhiều kiến thức và kỹ năng hữu ích.',
    imageUrl: 'https://api.dicebear.com/7.x/micah/svg?seed=Nguy%E1%BB%85n%20V%C4%83n%20A&backgroundColor=1e88e5',
  },
  {
    id: '2',
    name: 'Trần Minh B',
    role: 'Giảng viên Khoa CNTT',
    quote: 'Tôi rất hài lòng với hệ thống quản lý sự kiện mới, giúp việc tổ chức và điều phối trở nên dễ dàng hơn nhiều.',
    imageUrl: 'https://api.dicebear.com/7.x/micah/svg?seed=Tr%E1%BA%A7n%20Minh%20B&backgroundColor=d32f2f',
  },
  {
    id: '3',
    name: 'Lê Thị C',
    role: 'Trưởng CLB Truyền thông',
    quote: 'Nhờ sự hỗ trợ của các bộ phận quản lý, CLB chúng tôi đã tổ chức thành công nhiều sự kiện lớn trong năm học vừa qua.',
    imageUrl: 'https://api.dicebear.com/7.x/micah/svg?seed=L%C3%AA%20Th%E1%BB%8B%20C&backgroundColor=1e88e5',
  },
];
    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
          ...
          <div className="relative container mx-auto px-6 py-32 flex flex-col items-start">
            ...
            >
              <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">
                Chào mừng bạn đến với Học viện Công nghệ Bưu chính Viễn thông – Cơ sở TP.HCM (PTITHCM)
              </h1>
              <p className="text-xl text-white/90 mb-8">
                Nơi kết nối tri thức, sáng tạo và đổi mới trong lĩnh vực công nghệ thông tin và truyền thông
              </p>
          ...
          <div className="container mx-auto px-6">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <p className="text-gray-600 dark:text-gray-400 mb-6">
                  Học viện Công nghệ Bưu chính Viễn thông cơ sở tại TP.HCM (PTITHCM), được thành lập từ năm 1997, là cơ sở đào tạo công lập trực thuộc Bộ Thông tin và Truyền thông.
                </p>
                <p className="text-gray-600 dark:text-gray-400">
                  Với sứ mệnh đào tạo nguồn nhân lực chất lượng cao trong lĩnh vực công nghệ thông tin, điện tử viễn thông và kinh tế, PTITHCM không ngừng phát triển và khẳng định vị thế là một trong những cơ sở đào tạo hàng đầu về CNTT ở Việt Nam.
                </p>
              </motion.div>
            ...
            <div className="grid md:grid-cols-3 gap-8 mt-16">
              <Card>
                ...
                <CardContent>
                  <p className="text-gray-600 dark:text-gray-400">
                    Chương trình đào tạo hiện đại, đáp ứng nhu cầu thực tế của thị trường lao động trong lĩnh vực CNTT.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-gray-600 dark:text-gray-400">
                    Nghiên cứu khoa học và phát triển công nghệ luôn được chú trọng với nhiều đề tài, dự án có giá trị thực tiễn cao.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-gray-600 dark:text-gray-400">
                    Thường xuyên tổ chức các sự kiện học thuật, hội thảo, workshop và hoạt động ngoại khóa phong phú.
                  </p>
                </CardContent>
              </Card>
            </div>
        ...
        <section className="py-16 bg-gray-50 dark:bg-gray-900">
          <div className="container mx-auto px-6">
            <div className="text-center mb-12">
              ...
              <p className="mt-4 text-gray-600 dark:text-gray-400">Khám phá những sự kiện sắp diễn ra tại PTITHCM</p>
            </div>
        ...
        <section className="py-16 bg-white dark:bg-gray-950">
          <div className="container mx-auto px-6">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">Đánh giá từ người tham gia</h2>
              <div className="w-24 h-1 bg-red-600 mx-auto"></div>
              <p className="mt-4 text-gray-600 dark:text-gray-400">Những chia sẻ từ sinh viên và giảng viên đã tham gia sự kiện</p>
            </div>
        ...
        <section className="py-16 bg-gray-50 dark:bg-gray-900">
          <div className="container mx-auto px-6">
            <div className="max-w-3xl mx-auto text-center">
              <h2 className="text-3xl font-bold mb-4">Sẵn sàng tham gia sự kiện tại PTITHCM?</h2>
              <p className="text-gray-600 dark:text-gray-400 mb-8">
                Khám phá các sự kiện đang diễn ra và sắp diễn ra tại học viện của chúng tôi
              </p>
